...
class LoraConfig(PeftConfig):
    ...
    hash_r: Dict[str, int] = field(
        default_factory=dict,
        metadata={"help": "Best Rank for LDKiRA Layer"}
    )
    ...
    lora_nums: int = field(default=0, metadata={"help": "Numbers of Lora"})
    lora_moe_use: bool = field(default=False, metadata={"help": "Enable the use of LoRA MoE"})
    subspace_mixed: bool = field(default=False, metadata={"help": "If set to True, merge the subspace of U,V in SVD"})
    ohora_mix_alpha: float = field(default=0.5, metadata={"help": "Mixing coefficient for ohora_relative_scores_mix"})
    ...
    def to_dict(self):
        ...
        # Internal training-only metadata, not needed for adapter loading/evaluation.
        rv.pop("hash_r", None)
        rv.pop("ohora_mix_alpha", None)
        return rv
